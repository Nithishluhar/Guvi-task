...
import { FolderViewOutlined, FundProjectionScreenOutlined, IdcardOutlined, SaveOutlined, UserAddOutlined } from '@ant-design/icons';
    ...
    <div>
        <Typography.Title level={4} >Dashboard</Typography.Title >
         <Space direction = "horizontal">
            <Card >
                <Space direction='horizontal'>
                <SaveOutlined style={{fontSize : 40 ,color: "blue",borderRadius:20}} />
            ...
            <Card >
                <Space direction='horizontal'>
               <FundProjectionScreenOutlined style={{fontSize : 50 ,color: "green"}}/>
