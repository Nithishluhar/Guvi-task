        ...
        <div className="col-md-8">
          ...
          <div className="box-2">
            ...
            <div className="box-3">
             ...
             <div className="box-3">
              <span><b>Discount :</b> {item.discountPercentage}  % ✨</span>
            </div>
          </div>
        </div>
        <div className="col-lg-4">
          <div className="row1">
            <div className="col-4 col-sm-6">
              <div className="qty">
                <div className="div1">
                  <button className="btn btn-sm btn-info " onClick={() => handlereduce(index)}>➖</button>
                  <span><b>Qty:{item.quantity ? item.quantity
                        : "Click Remove "} </b></span>
                        <button className="btn btn-sm btn-info" onClick={() => handleplus(index)}>➕</button>
                  <button className="button text-bg-danger" onClick={() => handleDelete(index)}>Remove</button>
                </div>
              </div>
              <hr />
              <div className="Box">
